...
(function (global, factory) {
    ...
    /* template */
    var __vue_render__$4 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{ref:"label",class:_vm.rootClasses,attrs:{"disabled":_vm.disabled},on:{"click":_vm.focus,"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }$event.preventDefault();return _vm.$refs.label.click()}}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.computedValue),expression:"computedValue"}],ref:"input",attrs:{"type":"checkbox","disabled":_vm.disabled,"required":_vm.required,"name":_vm.name,"true-value":_vm.trueValue,"false-value":_vm.falseValue},domProps:{"indeterminate":_vm.indeterminate,"value":_vm.nativeValue,"checked":Array.isArray(_vm.computedValue)?_vm._i(_vm.computedValue,_vm.nativeValue)>-1:_vm._q(_vm.computedValue,_vm.trueValue)},on:{"click":function($event){$event.stopPropagation();},"change":function($event){var $$a=_vm.computedValue,$$el=$event.target,$$c=$$el.checked?(_vm.trueValue):(_vm.falseValue);if(Array.isArray($$a)){var $$v=_vm.nativeValue,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.computedValue=$$a.concat([$$v]));}else {$$i>-1&&(_vm.computedValue=$$a.slice(0,$$i).concat($$a.slice($$i+1)));}}else {_vm.computedValue=$$c;}}}}),_c('span',{class:_vm.checkClasses}),_c('span',{class:_vm.labelClasses},[_vm._t("default")],2)])};
    ...
    exports.Dropdown = Plugin$5;
    exports.Field = Plugin$6;
    exports.Icon = Plugin$7;
    exports.Input = Plugin$8;
    exports.Loading = Plugin$9;
    exports.LoadingProgrammatic = LoadingProgrammatic;
    exports.Modal = Plugin$a;
    exports.ModalProgrammatic = ModalProgrammatic;
    exports.Pagination = Plugin$b;
    exports.Radio = Plugin$c;
    exports.Select = Plugin$d;
    exports.Sidebar = Plugin$f;
    exports.Skeleton = Plugin$e;
    exports.Slider = Plugin$g;
    exports.Steps = Plugin$h;
    exports.Switch = Plugin$i;
    exports.Table = Plugin$j;
    exports.Tabs = Plugin$k;
    exports.Tooltip = Plugin$l;
    exports.Upload = Plugin$m;
