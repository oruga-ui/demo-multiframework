...
var script = {
  ...
  props: {
    ...
    position: {
      type: String,
      default: () => {
        return helpers.getValueByPath(plugins.config, 'tooltip.position', 'top');
      },
    ...
    triggers: {
      type: Array,
      default: () => {
        return helpers.getValueByPath(plugins.config, 'tooltip.triggers', ['hover']);
      }
    },
    ...
    animation: {
      type: String,
      default: () => {
        return helpers.getValueByPath(plugins.config, 'tooltip.animation', 'fade');
      }
    },
