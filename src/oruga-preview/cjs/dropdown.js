...
var script = {
  ...
  props: {
    ...
    maxHeight: {
      type: [String, Number],
      default: () => {
        return helpers.getValueByPath(plugins.config, 'dropdown.maxHeight', 200);
      }
    },
    ...
    mobileModal: {
      type: Boolean,
      default: () => {
        return helpers.getValueByPath(plugins.config, 'dropdown.mobileModal', true);
      }
    },
    ...
    animation: {
      type: String,
      default: () => {
        return helpers.getValueByPath(plugins.config, 'dropdown.animation', 'fade');
      }
    },
    ...
    trapFocus: {
      type: Boolean,
      default: () => {
        return helpers.getValueByPath(plugins.config, 'dropdown.trapFocus', true);
      }
    },
...
exports.ODropdown = __vue_component__;
exports.ODropdownItem = __vue_component__$1;
